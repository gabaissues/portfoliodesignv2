...
export const getServerSideProps = async(ctx: any) => {
  ...
  const res = await axios.get(`https://api.gabaissues.com/projects/listen/specify`, {
    headers: {
    ...
    <>
      ...
      <G.Main>
        <video
          controls
        >
          <source src={`https://api.gabaissues.com/public/${project?.data.videoName}`} type="video/mp4" />
        </video>
